# =====================================================
# STREAMLIT APP
# KLASIFIKASI + REGRESI + ENSEMBLE (FINAL & AMAN)
# =====================================================
...
# Numeric cleaning
num_cols = ["Units_Sold", "Unit_Price", "Revenue", "Unit_Cost"]
for col in num_cols:
...
st.success(f"Akurasi klasifikasi: {accuracy_score(yc_test, cls_model.predict(Xc_test)):.2f}")
